...
class Board:
    ...
    def place_dots(self):
        ...
        self.dots += [(i,370) for i in range(160,580,30) if i not in range(280,431,30)]             # Row 13
    ...
    def place_walls(self):
        ...
        self.walls += [(10,610), (100,610), (130,610), (580,610), (610,610), (700,610)]
        self.walls += [(i,640) for i in range(10,730,30) if i not in (70,160,250,460,550,640)]
        self.walls += [(10,670), (190,670), (220,670), (340,670), (370,670), (490,670), (520,670), (700,670)]
